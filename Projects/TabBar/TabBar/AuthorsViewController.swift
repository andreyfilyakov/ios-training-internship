...
class AuthorsViewController: UITableViewController {
    ...
    var authors = [Author(name: "Lev N. Tolstoy", country: "Russia"),
                   Author(name: "Nikolay V. Gogol", country: "Russia"),
                   Author(name: "George Orwell", country: "England"),
                   Author(name: "Mark Twain", country: "United States"),
                   Author(name: "Fedor M. Dostoevsky", country: "Russia")]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.addAction = {
            let favouritesController = self.tabBarController?.viewControllers![2] as? FavouritesViewController
            favouritesController?.addAuthor(self.authors[indexPath.row])
